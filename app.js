...
const solarSystem = [
    ...
    // 3. Console.log the sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune (131)
     ...
     console.log("Sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune :" + system.jupiter.satellites + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites);
    ...
    // 6. Find the difference between Jupiter's momentum and Pluto's momentum. (To get momentum, you'll want the product of velocity and mass).
        ...
        let momentum = momentum1 - momentum2;
        console.log("Jupiter Momentum " + momentum1 , "Plutos Momentum " + momentum2, "Difference " + momentum);
